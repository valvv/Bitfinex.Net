...
namespace Bitfinex.Net.UnitTests
{
    ...
    public class BitfinexSocketClientTests
    {
        ...
        public async Task SubscribingToBookUpdates_Should_SubscribeSuccessfully(Precision prec, Frequency freq)
        {
            ...
            var subTask = client.SubscribeToOrderBookUpdatesAsync("tBTCUSD", prec, freq, 25, data => result = data.Data.ToArray());
        ...
        [TestCase(KlineInterval.FiveMinute)]
        [TestCase(KlineInterval.FifteenMinute)]
        [TestCase(KlineInterval.ThirtyMinute)]
        [TestCase(KlineInterval.OneHour)]
        [TestCase(KlineInterval.ThreeHour)]
        [TestCase(KlineInterval.SixHour)]
        [TestCase(KlineInterval.TwelveHour)]
        [TestCase(KlineInterval.OneDay)]
        [TestCase(KlineInterval.SevenDay)]
        [TestCase(KlineInterval.FourteenDay)]
        ...
        public void SubscribingToTickerUpdates_Should_SubscribeSuccessfully()
        {
            ...
            var subTask = client.SubscribeToTickerUpdatesAsync("tBTCUSD", data => { });
        ...
        public void SubscribingToRawBookUpdates_Should_SubscribeSuccessfully()
        {
            ...
            var subTask = client.SubscribeToRawOrderBookUpdatesAsync("tBTCUSD", 10, data => { });
        ...
        public void SubscribingToRawBookUpdates_Should_TriggerWithRawBookUpdate()
        {
            ...
            var subTask = client.SubscribeToRawOrderBookUpdatesAsync("tBTCUSD", 10, data => result = data.Data.ToArray());
        ...
        public void SubscribingToOrderUpdates_Should_TriggerWithOrderUpdate(string updateType, BitfinexEventType eventType, bool single=true)
        {
            ...
            client.SubscribeToUserTradeUpdatesAsync(data =>
            {
                result = data.Data;
                rstEvent.Set();
            }, null, null);
        ...
        public void SubscribingToTradeUpdates_Should_TriggerWithTradeUpdate(string updateType, BitfinexEventType eventType, bool single = true)
        {
            ...
            client.SubscribeToUserTradeUpdatesAsync(null,
                data =>
                {
                    result = data.Data;
                    rstEvent.Set();
        ...
        public void SubscribingToWalletUpdates_Should_TriggerWithWalletUpdate(string updateType, BitfinexEventType eventType, bool single = true)
        {
            ...
            client.SubscribeToBalanceUpdatesAsync(data =>
                {
                    result = data.Data;
                    rstEvent.Set();
                });
        ...
        public void SubscribingToPositionUpdates_Should_TriggerWithPositionUpdate(string updateType, BitfinexEventType eventType, bool single = true)
        {
            ...
            client.SubscribeToUserTradeUpdatesAsync(null, null, data =>
            {
                result = data.Data;
                rstEvent.Set();
            });
        ...
        public void ReceivingAReconnectMessage_Should_ReconnectWebsocket()
        {
            ...
            var rstEvent = new ManualResetEvent(false);
            var subTask = client.SubscribeToKlineUpdatesAsync("tBTCUSD", KlineInterval.FiveMinute, data => { });
            socket.InvokeMessage(new CandleSubscriptionResponse()
            {
                ...
                ChannelId = 1,
                Symbol = "tBTCUSD",
                Key = "trade:" + JsonConvert.SerializeObject(KlineInterval.FiveMinute, new KlineIntervalConverter(false)) + ":tBTCUSD"
            });
        ...
        public async Task ReceivingAReconnectMessage_Should_PreventOperationsBeforeReconnect()
        {
            ...
            socket.OnOpen += async () =>
            {
                ...
                socket.InvokeMessage(new CandleSubscriptionResponse()
                {
                    ...
                    ChannelId = 1,
                    Symbol = "tBTCUSD",
                    Key = "trade:" + JsonConvert.SerializeObject(KlineInterval.FiveMinute, new KlineIntervalConverter(false)) +
                          ":tBTCUSD"
                });
            };
            ...
            {
                subResultWhenPaused = await client.SubscribeToKlineUpdatesAsync("tBTCUSD", KlineInterval.FiveMinute, data => { });
                rstEvent.Set();
            };
